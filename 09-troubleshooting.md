...
这是踩出来的完整清单，每条都花过一个调试周期。**8–15 是 2026-08 随 demo 06-10 补进来的**（PR #30）。
...
**最危险的是第 2、3、13、14 条**——它们不报错，产出的东西看起来完全正常。第 14 条尤其毒：**它让"什么都没发生"长得像"经过验证的否定结论"**。任何一条从子 agent 答复里得出的结论，都要先确认终态种类；从"没有"（没有孙 agent、没有匹配项）得出的结论，更要确认，而不是更不用。
